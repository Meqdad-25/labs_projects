...
def evaluate_model(model, X_train, X_test, y_train, y_test, model_name="Model"):
    ...
    MAE is printed first because it is the competition metric.
    Returns a dictionary so the results can be collected into a comparison table.
    """
    ...
    print(f'mae   for train = {train_mae:.2f}, and for test = {test_mae:.2f}')
    print(f'rmse  for train = {train_rmse:.2f}, and for test = {test_rmse:.2f}')
    print(f'score for train = {train_r2:.4f}, and for test = {test_r2:.4f}')
